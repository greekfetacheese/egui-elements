...
/// --background-primary
pub const INK: Color32 = Color32::from_rgba_premultiplied(26, 32, 35, 255);
/// --background-secondary
pub const SLATE: Color32 = Color32::from_rgba_premultiplied(34, 43, 47, 255);
/// Hover lift — gray step, no chroma.
pub const SLATE2: Color32 = Color32::from_rgba_premultiplied(52, 63, 67, 255);
/// --text-normal
pub const PARCHMENT: Color32 = Color32::from_rgba_premultiplied(250, 242, 214, 255);
/// --text-faint
pub const FAINT: Color32 = Color32::from_rgba_premultiplied(189, 174, 147, 255);
/// --text-accent / --link-color
pub const TEAL: Color32 = Color32::from_rgba_premultiplied(44, 202, 183, 255);
/// --h2-color. Links / info — cooler than teal.
pub const MIST: Color32 = Color32::from_rgba_premultiplied(138, 184, 189, 255);
/// --text-highlight-bg
pub const LIME: Color32 = Color32::from_rgba_premultiplied(201, 216, 106, 255);
/// Warm coral for danger (Reverie has no error token).
pub const CORAL: Color32 = Color32::from_rgba_premultiplied(224, 122, 95, 255);
/// Gruvbox aqua — Reverie already borrows gruvbox gray / faint.
pub const MOSS: Color32 = Color32::from_rgba_premultiplied(142, 192, 124, 255);
/// --background-modifier-border mixed 40% into INK. Structural stroke / shadow.
pub const TEAL_STEEL: Color32 = Color32::from_rgba_premultiplied(75, 96, 96, 255);
pub const FADED_STEEL: Color32 = Color32::from_rgba_premultiplied(75, 96, 96, 118);
/// SLATE2 mixed 28% toward TEAL. Selected / emphasis fill, not hover.
pub const HIGHLIGHT: Color32 = Color32::from_rgba_premultiplied(50, 102, 99, 255);
/// --text-accent-hover. Hover border chrome only — not a ThemeColors slot.
pub const HOVER_CHROME: Color32 = Color32::from_rgba_premultiplied(131, 165, 152, 255);
